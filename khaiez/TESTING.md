...
Test cần bao phủ Telex/hoàn tác kiểu UniKey, viết hoa đầu câu, hashtag/email, input policy, cursor/recomposition, selection deletion, touch dispatcher, repeat, gợi ý, voice routing, AI key pool/cancellation và sao lưu không chứa secret.
